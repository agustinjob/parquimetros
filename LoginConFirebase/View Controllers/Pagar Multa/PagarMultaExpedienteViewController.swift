//
//  PagarMultaExpedienteViewController.swift
//  LoginConFirebase
//
...
class PagarMultaExpedienteViewController: UIViewController {

     let transition = SlideInTransition()
    
    @IBOutlet weak var label1: UILabel!
    @IBOutlet weak var numExpTF: UITextField!
    ...
    func setUpElements(){
        ...
        Utilities.styleTextFieldWBorder(numExpTF, txt: "Numero de expediente")
...
extension PagarMultaExpedienteViewController: UIViewControllerTransitioningDelegate{
